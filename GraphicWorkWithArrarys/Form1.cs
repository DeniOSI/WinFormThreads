...
{
    public delegate void Timess(string time);
    ...
    public partial class FM_WorkWithArr : Form
    {
        ...
        {
            InitializeComponent();
           Control.CheckForIllegalCrossThreadCalls = false; //Отключение проверки перекресного вызова
        }
